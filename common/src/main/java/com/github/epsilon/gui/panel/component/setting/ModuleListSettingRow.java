...
public class ModuleListSettingRow extends SettingRow<ModuleListSetting> {

    public ModuleListSettingRow(ModuleListSetting setting) {
        super(setting);
    }
    ...
    public void buildUi(PanelUiTree.Scope scope, GuiGraphicsExtractor guiGraphics, TextRenderer textRenderer,
        ...
        String summary = setting.size() + EpsilonTranslations.Gui.LIST_MODULES.getTranslatedName();
