...
public class EnchantmentListSettingRow extends SettingRow<EnchantmentListSetting> {

    public EnchantmentListSettingRow(EnchantmentListSetting setting) {
        super(setting);
    }
    ...
    public void buildUi(PanelUiTree.Scope scope, GuiGraphicsExtractor guiGraphics, TextRenderer textRenderer,
        ...
        String summary = setting.size() + EpsilonTranslations.Gui.LIST_ENCHANTMENTS.getTranslatedName();
