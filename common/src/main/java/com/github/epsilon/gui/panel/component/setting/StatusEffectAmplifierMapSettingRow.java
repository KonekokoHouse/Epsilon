...
import com.github.epsilon.settings.impl.StatusEffectAmplifierMapSetting;
import net.minecraft.client.gui.GuiGraphicsExtractor;
import net.minecraft.client.input.MouseButtonEvent;

public class StatusEffectAmplifierMapSettingRow extends SettingRow<StatusEffectAmplifierMapSetting> {

    public StatusEffectAmplifierMapSettingRow(StatusEffectAmplifierMapSetting setting) {
        super(setting);
    }
    ...
    public void buildUi(PanelUiTree.Scope scope, GuiGraphicsExtractor guiGraphics, TextRenderer textRenderer,
        ...
        String summary = setting.getValue().size() + " effects";
