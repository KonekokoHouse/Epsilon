...
public class PacketListSettingRow extends SettingRow<PacketListSetting> {

    public PacketListSettingRow(PacketListSetting setting) {
        super(setting);
    }
    ...
    public void buildUi(PanelUiTree.Scope scope, GuiGraphicsExtractor guiGraphics, TextRenderer textRenderer,
        ...
        String summary = setting.size() + EpsilonTranslations.Gui.LIST_PACKETS.getTranslatedName();
