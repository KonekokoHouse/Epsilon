...
import com.github.epsilon.settings.impl.BlockPosSetting;
import net.minecraft.client.gui.GuiGraphicsExtractor;
import net.minecraft.client.input.MouseButtonEvent;

public class BlockPosSettingRow extends SettingRow<BlockPosSetting> {

    public BlockPosSettingRow(BlockPosSetting setting) {
        super(setting);
    }
    ...
    public void buildUi(PanelUiTree.Scope scope, GuiGraphicsExtractor guiGraphics, TextRenderer textRenderer,
        ...
        String summary = setting.getX() + ", " + setting.getY() + ", " + setting.getZ();
