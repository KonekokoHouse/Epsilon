...
public class ScreenHandlerListSettingWidget extends SettingWidget<ScreenHandlerListSetting> {
    ...
    public void draw(DropdownDrawContext renderer, int mouseX, int mouseY) {
        ...
        String label = setting.size() + EpsilonTranslations.Gui.LIST_SCREENS.getTranslatedName();
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        ...
        DropdownScreen.INSTANCE.openScreenHandlerListSettingPopup(setting);
