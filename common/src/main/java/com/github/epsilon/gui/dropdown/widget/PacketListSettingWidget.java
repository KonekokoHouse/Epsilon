...
public class PacketListSettingWidget extends SettingWidget<PacketListSetting> {
    ...
    public void draw(DropdownDrawContext renderer, int mouseX, int mouseY) {
        ...
        String label = setting.size() + EpsilonTranslations.Gui.LIST_PACKETS.getTranslatedName();
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        ...
        DropdownScreen.INSTANCE.openPacketListSettingPopup(setting);
