...
public class StorageBlockListSettingRow extends SettingRow<StorageBlockListSetting> {

    public StorageBlockListSettingRow(StorageBlockListSetting setting) {
        super(setting);
    }
    ...
    public void buildUi(PanelUiTree.Scope scope, GuiGraphicsExtractor guiGraphics, TextRenderer textRenderer,
        ...
        String summary = setting.size() + EpsilonTranslations.Gui.LIST_STORAGE.getTranslatedName();
