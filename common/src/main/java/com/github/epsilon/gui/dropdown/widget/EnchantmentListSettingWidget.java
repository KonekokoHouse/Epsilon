...
public class EnchantmentListSettingWidget extends SettingWidget<EnchantmentListSetting> {
    ...
    public void draw(DropdownDrawContext renderer, int mouseX, int mouseY) {
        ...
        String label = setting.size() + EpsilonTranslations.Gui.LIST_ENCHANTMENTS.getTranslatedName();
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        ...
        DropdownScreen.INSTANCE.openEnchantmentListSettingPopup(setting);
