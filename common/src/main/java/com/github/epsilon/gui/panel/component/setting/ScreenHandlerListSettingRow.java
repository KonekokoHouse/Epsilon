...
public class ScreenHandlerListSettingRow extends SettingRow<ScreenHandlerListSetting> {

    public ScreenHandlerListSettingRow(ScreenHandlerListSetting setting) {
        super(setting);
    }
    ...
    public void buildUi(PanelUiTree.Scope scope, GuiGraphicsExtractor guiGraphics, TextRenderer textRenderer,
        ...
        String summary = setting.size() + EpsilonTranslations.Gui.LIST_SCREENS.getTranslatedName();
