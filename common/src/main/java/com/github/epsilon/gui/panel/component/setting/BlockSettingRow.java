...
import com.github.epsilon.settings.impl.BlockSetting;
import net.minecraft.client.gui.GuiGraphicsExtractor;
import net.minecraft.client.input.MouseButtonEvent;
import net.minecraft.core.registries.BuiltInRegistries;
import net.minecraft.resources.Identifier;

public class BlockSettingRow extends SettingRow<BlockSetting> {

    public BlockSettingRow(BlockSetting setting) { super(setting); }
    ...
    public void buildUi(PanelUiTree.Scope scope, GuiGraphicsExtractor guiGraphics, TextRenderer textRenderer,
        ...
        Identifier id = BuiltInRegistries.BLOCK.getKey(setting.getValue());
