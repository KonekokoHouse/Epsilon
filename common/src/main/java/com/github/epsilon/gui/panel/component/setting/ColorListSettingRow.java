...
public class ColorListSettingRow extends SettingRow<ColorListSetting> {

    public ColorListSettingRow(ColorListSetting setting) {
        super(setting);
    }
    ...
    public void buildUi(PanelUiTree.Scope scope, GuiGraphicsExtractor guiGraphics, TextRenderer textRenderer,
        ...
        String summary = setting.size() + EpsilonTranslations.Gui.LIST_COLORS.getTranslatedName();
