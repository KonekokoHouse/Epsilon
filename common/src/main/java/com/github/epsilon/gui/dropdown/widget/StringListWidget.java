...
public class StringListWidget extends SettingWidget<StringListSetting> {
    ...
    public void draw(DropdownDrawContext renderer, int mouseX, int mouseY) {
        ...
        String label = setting.size() + EpsilonTranslations.Gui.LIST_ENTRIES.getTranslatedName();
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        ...
        DropdownScreen.INSTANCE.openStringListPopup(setting);
