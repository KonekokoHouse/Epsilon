...
public class StorageBlockListSettingWidget extends SettingWidget<StorageBlockListSetting> {
    ...
    public void draw(DropdownDrawContext renderer, int mouseX, int mouseY) {
        ...
        String label = setting.size() + EpsilonTranslations.Gui.LIST_STORAGE.getTranslatedName();
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        ...
        DropdownScreen.INSTANCE.openStorageBlockListSettingPopup(setting);
