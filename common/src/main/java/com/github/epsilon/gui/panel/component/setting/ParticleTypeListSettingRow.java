...
public class ParticleTypeListSettingRow extends SettingRow<ParticleTypeListSetting> {

    public ParticleTypeListSettingRow(ParticleTypeListSetting setting) {
        super(setting);
    }
    ...
    public void buildUi(PanelUiTree.Scope scope, GuiGraphicsExtractor guiGraphics, TextRenderer textRenderer,
        ...
        String summary = setting.size() + EpsilonTranslations.Gui.LIST_PARTICLES.getTranslatedName();
