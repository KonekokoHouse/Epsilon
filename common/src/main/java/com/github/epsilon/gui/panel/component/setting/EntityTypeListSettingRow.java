...
public class EntityTypeListSettingRow extends SettingRow<EntityTypeListSetting> {

    public EntityTypeListSettingRow(EntityTypeListSetting setting) {
        super(setting);
    }
    ...
    public void buildUi(PanelUiTree.Scope scope, GuiGraphicsExtractor guiGraphics, TextRenderer textRenderer,
        ...
        String summary = setting.size() + EpsilonTranslations.Gui.LIST_ENTITIES.getTranslatedName();
