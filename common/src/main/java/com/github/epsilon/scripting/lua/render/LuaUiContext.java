...
public final class LuaUiContext {
    ...
    public static LuaTable create(LuaRuntime runtime, UiTree.Scope scope) {
        ...
        api.set("text_width", function(args -> LuaValue.valueOf(MinecraftUiRuntime1211.current().textMetrics()
                .textWidth(args.arg(2).checkjstring(), number(args, 3), optionalString(args.arg(4))))));
        api.set("text_height", function(args -> LuaValue.valueOf(MinecraftUiRuntime1211.current().textMetrics()
